...
parser.add_argument('--data', type=str, default='nab_',
                    help='type of the dataset (ecg, gesture, power_demand, space_shuttle, respiration, nyc_taxi')
parser.add_argument('--filename', type=str, default='nab_.csv',
...
parser.add_argument('--lr', type=float, default=0.04,               #0.0002
...
parser.add_argument('--batch_size', type=int, default=32, metavar='N',  #64
                    help='batch size')
parser.add_argument('--eval_batch_size', type=int, default=32, metavar='N', #64
                    help='eval_batch size')
parser.add_argument('--bptt', type=int, default=50,                         #50
                    help='sequence length')
parser.add_argument('--teacher_forcing_ratio', type=float, default=0.7,     #0.7
...
parser.add_argument('--prediction_window_size', type=int, default=10,
                    help='prediction_window_size')          #10
